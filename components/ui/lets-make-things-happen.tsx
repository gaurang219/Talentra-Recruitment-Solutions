      ...
      >
        <div className="md:pr-[22rem]">
          ...
          <p className="my-10 text-xl">
            Schedule a consultation with Talentra Recruitment Solutions and
            let&apos;s discuss your career goals and how our team can support
            your job-search journey.
          </p>

          <Link href="/meeting" onClick={difftost}>
